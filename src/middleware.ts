...
//
// "/" is also public: it does its own auth() check and shows a
// lightweight signed-out landing state ("Sign in to see your
// accounts") rather than force-redirecting. If it weren't listed here,
// middleware would redirect a signed-out visitor to Clerk's sign-in
// before "/" ever got to render that state at all.
